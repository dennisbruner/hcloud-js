...
const FloatingIPActionsList = require('./floatingIPActionsList')

class FloatingIPActionsEndpoint {
  constructor (client) {
    this.client = client
  }
  ...
  list (id, params) {
    ...
    return this.client.axios({
      ...
      // Return a list
      return new FloatingIPActionsList(this, id, actions, response.data.meta)
    })
  }
...
module.exports = FloatingIPActionsEndpoint
