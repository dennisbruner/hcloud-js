module.exports = {
	...
	Volume: require('./volumes/volume'),
	VolumeList: require('./volumes/volumeList'),
	VolumeBuilder: require('./volumes/volumeBuilder'),
	VolumeActionList: require('./volumes/actions/volumeActionList'),
