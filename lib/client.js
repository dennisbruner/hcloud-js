...
const LoadBalancerTypesEndpoint = require('./loadBalancerTypes')
const LoadBalancerEndpoint = require('./loadBalancers')

// Server Metadata (https://docs.hetzner.cloud/#server-metadata)
const ServerMetadata = require('./serverMetadata')
class Client {
  constructor (opts) {
    opts = opts || {}
    ...
    this.loadBalancerTypes = new LoadBalancerTypesEndpoint(this)
    this.loadBalancers = new LoadBalancerEndpoint(this)
    this.serverMetadata = new ServerMetadata(this)
  }
}
